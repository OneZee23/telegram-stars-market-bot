...
node ./node_modules/ts-node/dist/bin.js -r tsconfig-paths/register -r dotenv/config --project ./tsconfig.json ./node_modules/typeorm/cli.js -d typeorm-cli-datasource.ts $all_args
