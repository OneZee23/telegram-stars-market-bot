...
- Поддержка нескольких прокси с автоматическим failover
- Отслеживание работоспособности прокси
- Система оповещений об истечении срока действия прокси
- TODO: Для MVP реализовано полу-ручное решение с оповещениями о необходимости обновления прокси через переменную `FRAGMENT_PROXIES_EXPIRES_AT`. В будущем можно добавить интеграцию с API сервиса прокси (например, Proxy6 API) для автоматической покупки и продления прокси.
